...
const countryInfo = {
  ...
  description: "Explore our impact in the Warm Heart of Africa, where we're bringing clean energy solutions to rural communities and urban centers. Our projects here demonstrate the transformative power of sustainable energy in developing nations.",
...
export default function MalawiGallery() {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-[#062516] mb-2">Rural Development</h3>
                  <p className="text-gray-600">Bringing power to communities that need it most</p>
                </div>
              </div>
            </div>
          </motion.div>
