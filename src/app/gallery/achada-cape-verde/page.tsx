...
const countryInfo = {
  name: "Achada, Cape Verde",
  subtitle: "Santiago Island",
  description: "Explore our energy projects in this vibrant community, where we're creating lasting positive impact through sustainable development. Our work here demonstrates how clean energy can transform lives and communities.",
  location: "Santiago Island, Cape Verde",
  population: "~15,000",
  projects: "Community Energy Solutions",
  impact: "Social Development"
};

export default function AchadaCapeVerdeGallery() {
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
        ...
        <div className="relative w-full h-[65vh] bg-[#062516] overflow-hidden">
          <div className="absolute inset-0">
            <Image
              src="/gallery/achacape1.jpeg"
              alt="Achada, Cape Verde"
              fill
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-[#062516] mb-2">Community Impact</h3>
                  <p className="text-gray-600">Empowering people through sustainable energy</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            {images.map((image, index) => (
              ...
              >
                <Image
                  src={image}
                  alt={`Achada, Cape Verde - Image ${index + 1}`}
                  fill
