...
const countryInfo = {
  name: "Maio, Cape Verde",
  subtitle: "Atlantic Ocean",
  description: "Discover our sustainable initiatives on this pristine island, where we're harnessing natural resources for clean energy generation. Our projects here showcase the perfect harmony between environmental preservation and energy innovation.",
  location: "Cape Verde Islands",
  population: "~7,000",
  projects: "Island Energy Solutions",
  impact: "Environmental Preservation"
};

export default function MaioCapeVerdeGallery() {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-[#062516] mb-2">Island Sustainability</h3>
                  <p className="text-gray-600">Preserving paradise through clean energy</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            {images.map((image, index) => (
              ...
              >
                <Image
                  src={image}
                  alt={`Maio, Cape Verde - Image ${index + 1}`}
                  fill
