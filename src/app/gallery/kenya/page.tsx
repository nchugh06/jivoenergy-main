...
const countryInfo = {
  ...
  description: "Experience our innovative energy solutions in Kenya, where we're driving the transition to renewable energy across diverse landscapes. From urban centers to rural communities, we're powering progress with sustainable solutions.",
  location: "East Africa",
  population: "~54.9 million",
  projects: "Renewable Energy Transition",
  impact: "Economic Growth"
};

export default function KenyaGallery() {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-[#062516] mb-2">Innovation</h3>
                  <p className="text-gray-600">Leading the way in renewable energy solutions</p>
                </div>
              </div>
            </div>
          </motion.div>
