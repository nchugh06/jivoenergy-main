...
const countryInfo = {
  ...
  description: "Witness our commitment to rebuilding and empowering communities through sustainable energy infrastructure and development projects. Our work in Liberia represents hope and progress for a brighter future.",
  location: "West Africa",
  population: "~5.2 million",
  projects: "Infrastructure Development",
  impact: "Community Rebuilding"
};

export default function LiberiaGallery() {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-[#062516] mb-2">Infrastructure</h3>
                  <p className="text-gray-600">Building the foundation for a sustainable future</p>
                </div>
              </div>
            </div>
          </motion.div>
