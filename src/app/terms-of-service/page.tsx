...
Last Updated: [12 June 2026]<br></br><br></br>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">            
            ...
            <div className="w-full">
              <h4 className="text-3xl font-bold text-[#085D36] mb-6">1. Introduction And Acceptance</h4>
              <p className="text-gray-600 leading-relaxed mb-6">
These Terms of Service ("Terms") govern access to and use of www.jivoenergy.com and any pages, content, forms or materials made available through the website (the "Website") operated by [insert full legal name of JIVO website operating entity], having its registered office at [insert registered office address] ("JIVO Energy", "JIVO", "we", "our" or "us").<br></br><br></br>
By accessing or using the Website, submitting a contact or careers form, or otherwise interacting with the Website, you agree to these Terms. If you do not agree, you should not use the Website. Where a form is submitted on behalf of an organisation, the person submitting the form represents that he or she is authorised to provide the information and interact with JIVO on behalf of that organisation.<br></br><br></br>
You represent that you are at least 18 years of age and have the legal capacity and authority to use the Website and accept these Terms. JIVO should obtain affirmative acceptance through an unticked checkbox at contact-form and careers-form submission points, with these Terms and the Privacy Policy hyperlinked.
              ...
              <h4 className="text-3xl font-bold text-[#085D36] mb-6">2. Use of Website / Acceptable Use</h4>
              <p className="text-gray-600 leading-relaxed mb-6">
The content on the Website is provided for general business and informational purposes only. JIVO may modify, update, suspend or discontinue any part of the Website at any time, subject to applicable law.<br></br><br></br>
You agree to use the Website only for lawful purposes and in a manner that does not infringe the rights of JIVO or any third party, restrict or inhibit use of the Website by others, or interfere with the security, integrity or operation of the Website.<br></br><br></br>
You must not: (a) scrape, crawl, data-mine, harvest or use automated means to access the Website except as permitted by law or by JIVO in writing; (b) introduce malware, viruses, harmful code or disruptive material; (c) attempt unauthorised access to systems, accounts, servers or networks; (d) bypass security measures, rate limits or access controls; (e) use Website content to train, fine-tune or develop artificial-intelligence, machine-learning or competing commercial products without written permission; (f) impersonate any person or entity; (g) submit false, misleading, unlawful, infringing or confidential third-party information; or (h) use the Website in a manner that could damage JIVO's reputation or business interests.
            ...
            <h4 className="text-3xl font-bold text-[#085D36] mb-6">3. Intellectual Property</h4>
              <p className="text-gray-600 leading-relaxed mb-6">
All content on the Website, including text, graphics, logos, trade marks, icons, images, videos, documents, design, layout, data compilations and other materials, is owned by JIVO Energy or its licensors and is protected by applicable intellectual-property and trade-mark laws.<br></br><br></br>
JIVO ENERGY, the JIVO logo, product names, project names and related branding are trade marks or identifiers of JIVO or its licensors. Nothing on the Website grants any licence, assignment or right to use any intellectual property, except that you may view, download and print Website pages for internal, non-commercial reference, provided that all proprietary notices are retained and the content is not modified, reproduced, distributed or used for commercial purposes without JIVO's prior written permission.
              ...
              <h4 className="text-3xl font-bold text-[#085D36] mb-6">4. Accuracy of Information and Disclaimer</h4>
              <p className="text-gray-600 leading-relaxed mb-6">
While JIVO makes reasonable efforts to keep Website content accurate and up to date, we do not warrant or guarantee the completeness, accuracy, adequacy, reliability, availability or timeliness of any content.<br></br><br></br>
The Website and its content are provided on an 'as is' and 'as available' basis, without warranties of any kind, whether express, implied, statutory or otherwise, including warranties of uninterrupted availability, error-free operation, fitness for a particular purpose, non-infringement, security or absence of harmful components, to the maximum extent permitted by law.<br></br><br></br>
...
<h4 className="text-3xl font-bold text-[#085D36] mb-6">5. Third-Party Links</h4>
              <p className="text-gray-600 leading-relaxed mb-6">
The Website may contain links to third-party websites, social media platforms and external resources for convenience or informational purposes. JIVO does not control, endorse or assume responsibility for the content, products, services, security, terms or privacy practices of any third-party website. Access to third-party websites is at your own risk and subject to the terms and policies of those websites.
              ...
              <h4 className="text-3xl font-bold text-[#085D36] mb-6">6. Privacy</h4>
              <p className="text-gray-600 leading-relaxed mb-6">
Your use of the Website and submission of information through the Website are also governed by JIVO's Privacy Policy, which is incorporated into these Terms by reference. In case of any inconsistency relating specifically to processing of personal information, the Privacy Policy will apply to that subject matter.
              ...
              <h4 className="text-3xl font-bold text-[#085D36] mb-6">7. User Submissions</h4>
              <p className="text-gray-600 leading-relaxed mb-6">
If you submit enquiries, messages, ideas, feedback, proposals, CVs or other information through the Website, you represent that you have the right to submit such information and that it is accurate, lawful and not misleading. Personal information submitted by you will be handled in accordance with the Privacy Policy.<br></br><br></br>
...
<h4 className="text-3xl font-bold text-[#085D36] mb-6">10. Suspension, Blocking and Termination</h4>
<p>
...
<h4 className="text-3xl font-bold text-[#085D36] mb-6">11. Changes To These Terms</h4>
<p>
...
<h4 className="text-3xl font-bold text-[#085D36] mb-6">12. Governing Law and Jurisdiction</h4>
<p>
