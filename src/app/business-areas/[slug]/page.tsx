...
const businessAreasData: {
  ...
  'solar-pv': {
    title: "Solar PV",
    description: "JIVO Energy delivers high-performance Solar PV solutions engineered for diverse grid conditions, harsh environmental climates, and evolving energy demands across Africa.",
    fullDescription: "JIVO Energy delivers high-performance Solar PV solutions engineered for diverse grid conditions, harsh environmental climates, and evolving energy demands across Africa. Our expertise combines advanced engineering, optimized plant performance, intelligent energy integration, and reliable project execution to develop scalable renewable energy infrastructure for utilities, industries, institutions, and remote applications.\n\nOur Solar PV capabilities span the complete project lifecycle from feasibility studies and detailed engineering through procurement, construction, testing, and commissioning to operations and maintenance. We specialize in utility-scale power plants, commercial and industrial (C&I) applications, and solar farm development with proven track records across multiple African countries.\n\nWith advanced monitoring systems, performance optimization technologies, and dedicated O&M teams, we ensure maximum energy yield, operational reliability, and long-term asset performance. Our solutions are designed to integrate seamlessly with existing grid infrastructure while supporting Africa's renewable energy transition goals.",
    image: solarPV,
