...
const Team = () => {
  ...
  const projectExecution: TeamMember[] = [
    ...
    { name: 'Akshay Sharma', image: '/team/Akahsy.png' },
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-[#FFFA84] selection:text-[#062516] overflow-x-hidden">
      <Navbar />
