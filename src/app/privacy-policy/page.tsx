...
{/* Initiative Section */}
      ...
      <section className="py-30 bg-gray-50">        
        <div className="container mx-auto px-4">
            ...
            <p>Effective Date: [12 June 2026]<br></br>
Last Updated: [12 June 2026]<br></br><br></br>
</p>
          <div className="flex flex-col md:flex-row items-center gap-12">            
            
            <div className="w-full">
              <h4 className="text-3xl font-bold text-[#085D36] mb-6">1. Introduction</h4>
...
For the purposes of applicable data-protection laws, JIVO Energy will be the body corporate / data fiduciary / controller that determines the purposes and means of processing personal information collected through the website, unless a specific notice states otherwise.<br></br><br></br>
Providing personal information through the website is voluntary. However, if you do not provide information requested in a contact, enquiry or careers form, we may be unable to respond to your enquiry, evaluate your application, or provide the requested information.
              ...
              <h4 className="text-3xl font-bold text-[#085D36] mb-6">2. Information We Collect</h4>
              <p className="text-gray-600 leading-relaxed mb-6">
We may collect the following categories of personal information, depending on how you interact with us:
<h4 className="text-xl font-semibold text-gray-800 mb-4 mt-4">2.1 Information You Provide</h4>
Contact and business enquiry data: full name, email address, phone number, company / organisation name, designation or role, area of interest, country/location, and any information included in your message or communication.<br></br><br></br>
Careers and recruitment data: CV/resume, employment history, educational qualifications, professional skills, references, portfolio or project information, and other information submitted by you through the Careers section or in connection with recruitment.<br></br><br></br>
...
Where applicable, our legal bases / grounds for processing include: your consent; processing necessary to respond to your request or take steps prior to entering into a contract; performance of a contract; compliance with legal obligations; voluntary provision of personal data for a specified purpose; and our legitimate interests in responding to business enquiries, operating and securing the website, managing business relationships and improving services, provided such interests are not overridden by applicable law.
              ...
              <h4 className="text-3xl font-bold text-[#085D36] mb-6">4. Consent and Withdrawal</h4>
              <p className="text-gray-600 leading-relaxed mb-6">
Where processing is based on consent, you may withdraw your consent at any time by using the contact details stated in this Policy or by using any consent-management option made available on the website. Withdrawal of consent will not affect the lawfulness of processing carried out before withdrawal.<br></br><br></br>
...
<h4 className="text-3xl font-bold text-[#085D36] mb-6">5. Cookies and Analytics</h4>
              <p className="text-gray-600 leading-relaxed mb-6">
Our website may use cookies and similar technologies to remember user preferences, improve website performance, analyse visitor behaviour, enhance user experience, secure the website and understand how visitors interact with our content.<br></br><br></br>
...
<h4 className="text-3xl font-bold text-[#085D36] mb-6">8. Data Security</h4>
<p>
We implement reasonable technical, organisational and security measures designed to protect personal information against unauthorised access, disclosure, alteration, loss, misuse or destruction. These measures may include access controls, authentication, encryption or obfuscation where appropriate, secure configurations, logging and monitoring, backups, vendor controls, internal policies and incident-response processes.<br></br><br></br>
No method of transmission over the internet or method of electronic storage is completely secure. Accordingly, while we take reasonable measures to protect personal information, we cannot guarantee absolute security.</p>

<h4 className="text-3xl font-bold text-[#085D36] mb-6">9. Data Retention</h4>
<p>
We retain personal information only for as long as necessary for the purposes for which it was collected, including to respond to enquiries, manage business relationships, process recruitment applications, maintain website security, comply with legal, regulatory, accounting or reporting obligations, resolve disputes and enforce agreements.<br></br><br></br>
Indicatively, enquiry and business-contact data may be retained for the duration of the business relationship and for a reasonable period thereafter; recruitment data may be retained for the recruitment process and for a reasonable period after the role closes or as required by law; technical logs may be retained for security, audit and diagnostic purposes for a limited period; and records required for legal or regulatory purposes may be retained for the period required by applicable law.<br></br><br></br>
...
<h4 className="text-3xl font-bold text-[#085D36] mb-6">11. Grievance Redressal</h4>
<p>
...
Grievance Officer: [insert name/designation]<br></br>
Email: [privacy@jivoenergy.com / insert dedicated privacy email]<br></br>
Postal Address: [insert full address]
</p>

<h4 className="text-3xl font-bold text-[#085D36] mb-6">12. Third-Party Links</h4>
<p>
...
<h4 className="text-3xl font-bold text-[#085D36] mb-6">13. Children's Privacy</h4>
<p>
Our website and services are intended for businesses, organisations and adults. We do not knowingly collect personal information from children under 18 years of age. If we become aware that personal information of a child has been collected without appropriate lawful basis or consent, we will take reasonable steps to delete such information, subject to applicable law.</p>

<h4 className="text-3xl font-bold text-[#085D36] mb-6">14. Changes to This Policy</h4>
<p>
We may update this Privacy Policy periodically. Any updates will be posted on this page with a revised effective date / last updated date. Where changes are material, we may provide a prominent notice on the website and, where appropriate, notify affected individuals by email or other reasonable means.</p>

<h4 className="text-3xl font-bold text-[#085D36] mb-6">15. Contact Us</h4>
<p>
For privacy-related questions, rights requests or grievances, please contact:<br></br><br></br>
JIVO Energy - JIVO ENERGY PVT LTD<br></br>
India Office: 108-111, First Floor, Tower B, Spaze Business Park, Sector-66, Gurugram, Haryana, India<br></br>
Email:<a href="mailto:africa@jivoenergy.com" target="_blank"> africa@jivoenergy.com</a><br></br>
